...
import { useAllPairsInEddaswap, useAllTokensInEddaswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInEddaswap()
  const allTokenData = useAllTokenData()
  let allPairs = useAllPairsInEddaswap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search Eddaswap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
