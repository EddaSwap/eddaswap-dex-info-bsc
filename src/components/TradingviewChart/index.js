...
const TradingViewChart = ({
  ...
  useEffect(() => {
    if (!chartCreated && formattedData) {
      ...
      var series =
        type === CHART_TYPES.BAR
          ? chart.addHistogramSeries({
              color: darkMode ? eddaPrimaryColor : eddaPrimaryColor,
              priceFormat: {
                type: 'volume',
              },
              scaleMargins: {
              ...
              lineColor: darkMode ? eddaPrimaryColor : eddaPrimaryColor,
              lineWidth: 3,
            })
          : chart.addAreaSeries({
              topColor: darkMode ? eddaPrimaryColor : eddaPrimaryColor,
      ...
      let color = percentChange >= 0 ? 'green' : darkMode ? eddaPrimaryColor : eddaPrimaryColor
