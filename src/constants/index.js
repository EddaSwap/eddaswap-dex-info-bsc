...
export const SUPPORTED_LIST_URLS__NO_ENS = [
  'https://ipfs.infura.io/ipfs/Qmaq4yyBsYA2y968MhpszfW1NtLJDtdAw1qCSuws9tm2Vs',
]
...
export const UNTRACKED_COPY = 'Derived USD values may be inaccurate without liquid stablecoin or BNB pairings.'
