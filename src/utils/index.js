...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://dex.eddaswap.com/exchange?inputCurrency=${token0Address}`
  } else {
    return `https://dex.eddaswap.com/exchange?inputCurrency=${
      token0Address === '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c' ? 'BNB' : token0Address
    }&outputCurrency=${token1Address === '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c' ? 'BNB' : token1Address}`
  }
}

export function getEddaswapAppLink(linkVariable) {
