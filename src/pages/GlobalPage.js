...
import networkLogo from '../assets/bsc.jpg'
...
function GlobalPage() {
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.6, '#9f1bff')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            ...
            >
              <Network>
                ...
                />
                {/* <span style={{ color: 'white', fontWeight: 'bold' }}>BSC</span> */}
                <NetworkName>BSC</NetworkName>
              </Network>
              <TYPE.largeHeader>{below800 ? 'Eddaswap Analytics' : 'Eddaswap Analytics'}</TYPE.largeHeader>
            </div>
            <Search />
            <GlobalStats />
          </AutoColumn>
