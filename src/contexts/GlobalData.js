...
/**
 * Loop through every pair on eddaswap, used for search
 */
...
/**
 * Loop through every token on eddaswap, used for search
 */
...
export function useAllPairsInEddaswap() {
  const [state] = useGlobalDataContext()
  let allPairs = state?.allPairs
  return allPairs || []
}

export function useAllTokensInEddaswap() {
  const [state] = useGlobalDataContext()
